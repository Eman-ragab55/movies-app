  ...
  return (
    <section className="max-w-7xl mx-auto px-5 py-10">
      ...
      <div className="relative group">
        ...
        {/* السهم الشمال */}
        <button className="prev absolute left-0 top-1/2 -translate-y-1/2 z-20
        ...
        {/* السهم اليمين */}
        <button className="next absolute right-0 top-1/2 -translate-y-1/2 z-20
        w-12 h-12 rounded-full bg-black/60 text-white text-xl
        flex items-center justify-center
        opacity-0 group-hover:opacity-100 transition">
          ›
        ...
        >
          {upcome.map((movie) => (
            <SwiperSlide key={movie.id}>
              <div className="relative group cursor-pointer overflow-hidden rounded-lg hover:scale-105 transition">
